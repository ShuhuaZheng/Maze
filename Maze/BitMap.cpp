...
temp_red = m_rgba_data[4 * (temp_x + temp_y * m_info.biWidth)];
temp_green = m_rgba_data[4 * (temp_x + temp_y * m_info.biWidth) + 1];
temp_blue = m_rgba_data[4 * (temp_x + temp_y * m_info.biWidth) + 2];
temp_alpha = m_rgba_data[4 * (temp_x + temp_y * m_info.biWidth) + 3];
